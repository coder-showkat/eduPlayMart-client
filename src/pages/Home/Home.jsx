    ...
    const fetchData = async () => {
      try {
        ...
        const bannerContent = await fetch(
          "https://eduplaymart-sam.vercel.app/api/banner-contents"
        ).then((res) => res.json());

        // for how it works section
        const contents = await fetch(
          "https://eduplaymart-sam.vercel.app/api/hiw-contents"
        ).then((res) => res.json());

        // for gallery section
        const gallery = await fetch(
          "https://eduplaymart-sam.vercel.app/api/gallery"
        ).then((res) => res.json());

        // for features section
        const features = await fetch(
          "https://eduplaymart-sam.vercel.app/api/features"
        ).then((res) => res.json());

        // for testimonials section
        const testimonials = await fetch(
          "https://eduplaymart-sam.vercel.app/api/testimonials"
        ).then((res) => res.json());
